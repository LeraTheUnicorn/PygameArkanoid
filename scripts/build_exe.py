...
def build_executable():
    ...
    try:
        ...
        cmd = [
            ...
            '--add-data', f'{os.path.join(project_root, "sounds")};sounds',
            '--add-data', f'{os.path.join(project_root, "images")};images',
            '--add-data', f'{os.path.join(project_root, "game_resources", "sounds")};sounds',
            '--add-data', f'{os.path.join(project_root, "game_resources", "images")};images',
