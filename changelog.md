...
- **Исправлено отображение подсказки о звуке** - подсказка "Нажмите M для отключения звука" теперь отображается только на первом экране (ввод имени игрока)
- **Удалены дублирующие подсказки** - убраны подсказки "M - переключение звука" из экрана результатов игры и экрана таблицы рекордов
- **Улучшена подсказка о продолжении** - изменена с "Нажмите Enter для продолжения" на "После ввода имени нажмите Enter для продолжения"
- **Добавлена валидация ввода имени** - принимаются только буквы и цифры для имени игрока
- **Добавлена визуальная обратная связь** - фон поля ввода становится красным при вводе недопустимых символов
- **Создана функция валидации** - is_valid_player_name_char() для проверки допустимых символов

### Технические улучшения
- Добавлена проверка допустимых символов с помощью функции isalnum()
- Улучшена обработка ввода символов в функции get_player_name()
- Добавлена проверка валидности всего текста для изменения цвета фона
