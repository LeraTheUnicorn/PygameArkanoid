...
class GameState:
    ...
    @classmethod
    def create_from_game_objects(cls, ball, paddle, bricks, score: int, start_time: int) -> 'GameState':
    ...
    def update_from_result(self, action_result: dict):
        ...
        if 'hit_bricks' in action_result:
            ...
            self.remaining_bricks = [b for b in self.remaining_bricks if b not in hit_bricks]
    ...
    def clone(self) -> 'GameState':
        ...
        return GameState(
            ...
            predicted_trajectory=self.predicted_trajectory.copy() if self.predicted_trajectory else None,
