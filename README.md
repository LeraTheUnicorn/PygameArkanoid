...
- Исправлены пути к ресурсам для корректной работы в exe
- Организована структура сборки с отдельными каталогами
- Добавлены специализированные скрипты сборки без диалогов
