...
![Версия](https://img.shields.io/badge/version-1.7.0-blue.svg)
...
**Скачайте готовый файл:** `FINAL_RELEASE/Arkanoid_v1.7.0.exe`
- **Размер:** ~30 МБ
...
**EXE инсталлятор:** `FINAL_RELEASE/Arkanoid_v1.7.0_Setup.exe`
...
**MSI инсталлятор:** `FINAL_RELEASE/Arkanoid_v1.7.0_Setup.msi`
...
- Добавлен авторежим игры по клавише "0" с именем "robot"
- Улучшена физика отскока мяча от платформы с учетом точного смещения
- Добавлена случайность для предотвращения строго вертикального движения
- Удален визуальный шлейф мяча для повышения производительности
- Упрощена валидация имени игрока (только буквы)
- Добавлена подсказка "0 - авторежим" на экран ввода имени
