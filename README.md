...
![Версия](https://img.shields.io/badge/version-1.8.1-blue.svg)
...
**Скачайте готовый файл:** `FINAL_RELEASE/Arkanoid_v1.8.1.exe`
- **Размер:** ~30 МБ
...
**EXE инсталлятор:** `FINAL_RELEASE/Arkanoid_v1.8.1_Setup.exe`
...
**MSI инсталлятор:** `FINAL_RELEASE/Arkanoid_v1.8.1_Setup.msi`
