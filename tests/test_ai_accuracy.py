...
from PyGameBall import Paddle, Ball, build_bricks, AIPlayer, SCREEN_WIDTH, SCREEN_HEIGHT, PADDLE_SPEED
...
def main():
    ...
    if passed == total:
        ...
        print("AI should now provide better paddle positioning and trajectory prediction")
        return True
    else:
