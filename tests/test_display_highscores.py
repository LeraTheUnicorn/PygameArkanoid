...
def test_display_highscores_format():
    ...
    try:
        ...
        data_lines = [line for line in lines if line.strip() and not line.startswith('Место |') and not line.startswith('-') and not line.startswith('=')]
        ...
        for i, line in enumerate(data_lines[:3], 1):
            ...
            if separator_count == 3:
                ...
                print(f"  [ERROR] Неправильное количество разделителей: {separator_count}")
