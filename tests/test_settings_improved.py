...
class TestSettingsValidator:
    ...
    def test_validate_ball_speed_float(self):
    ...
    def test_validate_settings(self):
        ...
        validated = SettingsValidator.validate_settings(valid_settings)
...
class TestSettingsManager:
    ...
    def test_set_ball_speed_valid(self):
    ...
    def test_set_ball_speed_invalid(self):
    ...
    def test_auto_mode_limits(self):
    ...
    def test_file_size_limit(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            large_data = {"ball_speed": 5, "large_field": "x" * (SettingsConstants.MAX_SETTINGS_FILE_SIZE + 1)}
            with open(settings_file, "w", encoding="utf-8") as f:
