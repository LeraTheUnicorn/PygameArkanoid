...
def test_interface_flow_simulation():
    ...
    print("[OK] Сигнатура show_highscores(): (screen, font, highscore_manager, exit_on_esc=False)")
    print("[OK] Сигнатура get_player_name(): (screen, font, big_font, highscore_manager)")
    print("[OK] Сигнатура show_game_results(): (screen, font, big_font, score, player_name, time, manager)")
